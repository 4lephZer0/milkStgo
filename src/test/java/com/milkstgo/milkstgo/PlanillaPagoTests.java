...
public class PlanillaPagoTests {
    ...
    /*
    @Test
    void test1TraerPlanillaDeProv(){

        /*
        String quincenaStr = "2023/05/01";
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/dd");
        LocalDate quincena = LocalDate.parse(quincenaStr, formatter);

        String codigoProv = "01001";
        String nombreProv = "Pepe";
        Integer totalKlsLeche = 50;
        Integer diasEnvioLeche = 11;
        double promKlsLeche = 18.2;
        double variacionLeche = 0;
        Integer porcentajeGrasas = 10;
        double variacionGrasas = 0;
        Integer solidosTotales = 30;
        double variacionST = 0;
        Integer pagoLeche = 35000;
        Integer pagoGrasa = 1500;
        Integer pagoST = 1500;
        double bonoFrecuencia = 4560.0;
        Integer dctoVarLeche = 0;
        Integer dctoVarGrasa = 0;
        Integer dctoVarST = 0;
        Integer pagoTotal = 42560;
        Integer montoRetencion = 0;
        Integer montoFinal = 42560;

        PlanillaPagoEntity planillaPagoEntity = new PlanillaPagoEntity(null, quincena, codigoProv, nombreProv, totalKlsLeche, diasEnvioLeche, promKlsLeche,
                                                                        variacionLeche, porcentajeGrasas, variacionGrasas, solidosTotales, variacionST,
                                                                        pagoLeche, pagoGrasa, pagoST, bonoFrecuencia, dctoVarLeche, dctoVarGrasa,
                                                                        dctoVarST, pagoTotal, montoRetencion, montoFinal);
